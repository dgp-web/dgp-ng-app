import { ConnectedScatterPlotDocsComponent } from "./connected-scatter-plot-docs.component";
import { HeatmapDocsComponent } from "./heatmap-docs.component";
import { BarChartDocsComponent } from "./bar-chart-docs.component";
